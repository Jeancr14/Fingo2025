...
--  Creaci�n de tablespace y usuario

-- el archivo 'fingo_ts.dbf' se crea en el directorio por defecto del ORACLE_HOME.
CREATE TABLESPACE fingo_ts
  DATAFILE 'fingo_ts.dbf'
  SIZE 50M
  AUTOEXTEND ON NEXT 10M MAXSIZE UNLIMITED
  EXTENT MANAGEMENT LOCAL;
 -- TABLESPACE FINGO_TS creado.


CREATE USER fingo_user IDENTIFIED BY fingo123
  DEFAULT TABLESPACE fingo_ts
  TEMPORARY TABLESPACE temp
  QUOTA UNLIMITED ON fingo_ts;

GRANT CONNECT, RESOURCE TO fingo_user;
GRANT CREATE SESSION TO fingo_user;
GRANT UNLIMITED TABLESPACE TO fingo_user;
GRANT CREATE VIEW, CREATE PROCEDURE, CREATE TRIGGER, CREATE SEQUENCE, CREATE TABLE TO fingo_user;

-- Usar el esquema del usuario para que las siguientes DDL/PLSQL se creen ahi
ALTER SESSION SET CURRENT_SCHEMA = fingo_user;

--  Creaci�n de tablas, secuencias y triggers para autoincremento
...
-- 8) pruebas (comentar o ejecutar seg�n sea necesario)
...
ALTER TABLE usuarios MOVE TABLESPACE fingo_ts;
ALTER TABLE categorias MOVE TABLESPACE fingo_ts;
ALTER TABLE finanzas MOVE TABLESPACE fingo_ts;
ALTER TABLE configuracion MOVE TABLESPACE fingo_ts;
ALTER TABLE reportes MOVE TABLESPACE fingo_ts;
ALTER TABLE historial MOVE TABLESPACE fingo_ts;
ALTER TABLE alertas MOVE TABLESPACE fingo_ts;
ALTER TABLE familiares MOVE TABLESPACE fingo_ts;
ALTER TABLE metas_financieras MOVE TABLESPACE fingo_ts;
ALTER TABLE presupuestos MOVE TABLESPACE fingo_ts;
ALTER TABLE logs_acceso MOVE TABLESPACE fingo_ts;
